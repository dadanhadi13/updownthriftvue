                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel :dots="false" :nav="false" class="product-thumbs-track ps-slider">
                                    <div class="pt" @click="gantiGambar(thumbs[0])" :class="thumbs[0] == foto_default ? 'active' : '' ">
                                        <img src="img/mickey1.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="gantiGambar(thumbs[1])" :class="thumbs[1] == foto_default ? 'active' : '' ">
                                        <img src="img/mickey2.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="gantiGambar(thumbs[2])" :class="thumbs[2] == foto_default ? 'active' : '' ">
                                        <img src="img/mickey3.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="gantiGambar(thumbs[3])" :class="thumbs[3] == foto_default ? 'active' : '' ">
...
import HeaderUDT from '@/components/HeaderUDT.vue'
import FooterUDT from '@/components/FooterUDT.vue'
import RelatedUDT from '@/components/RelatedUDT.vue'
...
export default {
    ...
    methods: {
        gantiGambar(urlImage) {
            this.foto_default = urlImage;
        }
    }
}
</script>
